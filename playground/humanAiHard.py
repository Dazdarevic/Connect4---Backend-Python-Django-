...
#  da li je trenutno stanje table zavrsno (pobeda, poraz ili nereseno) :D
...
def minimax(board, depth, alpha, beta, maximizing_player):
    ...
    if maximizing_player:
        ...
        for col in valid_locations:
            # kopija tabele, kako mi se ne bi ona zadata izgubila
...
def drop_piece(board, col, piece):
    ...
    for r in range(ROWS - 1, -1, -1):  # iteriramo od dna ka vrhu
...
def get_best_move(request):
    ...
    print(f"Current board state: {board}")  # dobar je board-a
